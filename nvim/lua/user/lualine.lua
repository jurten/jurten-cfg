...
local status_theme_ok, theme = pcall(require, "user.themelualine")
...
vim.api.nvim_set_hl(0, "SLGitIcon", { fg = "#E8AB53", bg = gray })
vim.api.nvim_set_hl(0, "SLTermIcon", { fg = purple, bg = gray })
vim.api.nvim_set_hl(0, "SLBranchName", { fg = "#abb2bf", bg = gray, bold = false })
vim.api.nvim_set_hl(0, "SLLanguage", { fg = "#abb2bf", bg = gray, bold = false })
...
vim.api.nvim_set_hl(0, "SLLSP", { fg = dark_gray, bg = dark_gray })
vim.api.nvim_set_hl(0, "SLSep", { fg = gray, bg = dark_gray })
vim.api.nvim_set_hl(0, "SLFG", { fg = dark_gray, bg = gray })
vim.api.nvim_set_hl(0, "SLSeparator", { fg = "#6b727f", bg = dark_gray, italic = true })
...
local lanuage_server = {
    function()
        ...
        if client_names_str_len ~= 0 then
            language_servers = hl_str("", "SLSep") .. hl_str(client_names_str, "SLLanguage") .. hl_str("", "SLSep")
        end
        if copilot_active then
            language_servers = "%#SLCopilot#" .. " " .. icons.git.Octoface .. " %*" .. language_servers
        end
